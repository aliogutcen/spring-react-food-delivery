...
public class RabbitConfig {
    ...
    private String quequeRegisterCustomer = "queque-register-customer";
     ...
     */
    @Bean
    Queue quequeRegisterCustomer() {
        return new Queue(quequeRegisterCustomer);
    }
    @Bean
    ...
    @Bean
    Binding registerCustomer(FanoutExchange fanoutExchangeCustomer, Queue quequeRegisterCustomer) {
        return BindingBuilder.bind(quequeRegisterCustomer).to(fanoutExchangeCustomer);
    }
    /**
     * FINISH
     AUTH-MICROSERVICES REGISTER USER AND CUSTOMER MICROSERVICE REGISTER USER
